...
data <- read.csv("clean/data_new_name.csv", na = c("#NULL!", "", "Refused", "NA"), stringsAsFactors = F)
data1 <- read.csv("clean/data_new_name.csv", na = c("#NULL!", "", "Refused", "NA"))
...
data1$ppagecat <- as.factor(data$ppagecat)
summary(data1$ppagecat)


# age cat 4
unique(data$ppagect4)
data1$ppagect4 <- as.factor(data$ppagect4)
summary(data1$ppagect4)
...
summary(data1$PPETHM)


# gender
data1$PPGENDER <- relevel(data1$PPGENDER, "Female")
str(data1$PPGENDER)


# head of household
data1$PPHHHEAD <- relevel(data1$PPHHHEAD, "Yes")
summary(data1$PPHHHEAD)
...
summary(data1$PPMARIT)


# employment status
unique(data$PPWORK)
data1$PPWORK <- as.factor(data$PPWORK)
summary(data1$PPWORK)
...
data1$Q1 <- factor(data$Q1, levels = yn.lab)
data1$Q2 <- relevel(data1$Q2, "Yes")
data1$Q3 <- factor(data$Q3, levels = yesnodk.lab)
levels(data1$Q3)
...
data1$Q9 <- factor(data$Q9, levels = yesnodk.lab)
levels(data1$Q9)
...
levels(data1$Q10_9)
data1$Q11_1 <- factor(data$Q11_1, levels = q11.lab)
data1$Q11_2 <- factor(data$Q11_2, levels = q11.lab)
data1$Q11_3 <- factor(data$Q11_3, levels = q11.lab)
data1$Q11_4 <- factor(data$Q11_4, levels = q11.lab)
data1$Q11_5 <- factor(data$Q11_5, levels = q11.lab)
data1$Q11_6 <- factor(data$Q11_6, levels = q11.lab)
data1$Q11_7 <- factor(data$Q11_7, levels = q11.lab)
data1$Q11_8 <- factor(data$Q11_8, levels = q11.lab)
data1$Q11_9 <- factor(data$Q11_9, levels = q11.lab)
data1$Q11_10 <- factor(data$Q11_10, levels = q11.lab)
data1$Q11_11 <- factor(data$Q11_11, levels = q11.lab)
levels(data1$Q11_1)

data1$Q12_1 <- factor(data$Q12_1, levels = always.lab)
data1$Q12_2 <- factor(data$Q12_2, levels = always.lab)
data1$Q12_3 <- factor(data$Q12_3, levels = always.lab)
data1$Q12_4 <- factor(data$Q12_4, levels = always.lab)
data1$Q12_5 <- factor(data$Q12_5, levels = always.lab)
data1$Q12_6 <- factor(data$Q12_6, levels = always.lab)
data1$Q12_7 <- factor(data$Q12_7, levels = always.lab)
data1$Q12_8 <- factor(data$Q12_8, levels = always.lab)
data1$Q12_9 <- factor(data$Q12_9, levels = always.lab)
data1$Q12_10 <- factor(data$Q12_10, levels = always.lab)
data1$Q12_11 <- factor(data$Q12_11, levels = always.lab)
data1$Q12_12 <- factor(data$Q12_12, levels = always.lab)
data1$Q12_13 <- factor(data$Q12_13, levels = always.lab)
data1$Q12_14 <- factor(data$Q12_14, levels = always.lab)
data1$Q12_15 <- factor(data$Q12_15, levels = always.lab)
levels(data1$Q12_15)

data1$Q13 <- factor(data$Q13, levels = c("Yes, every year", "Yes, some years", "No, never"))
data1$Q14 <- factor(data$Q14, levels = c("$0", "Less than $30", "$30 to $60", "More than $60", "Don_t know"))
data1$Q15 <- factor(data$Q15, levels = likely.lab)
data1$Q16 <- factor(data$Q16, levels = likely.lab)
...
data1$Q20 <- factor(data$Q20, levels = c("Very effective", "Somewhat effective", "It varies from season to season", "Not effective", "Don_t know"))
data1$Q21 <- factor(data$Q21, levels = c("Yes, the full cost is paid", "Yes, but only part of the cost is paid", "No", "Don_t know"))
data1$Q22_1 <- factor(data$Q22_1, levels = always.lab)
data1$Q22_2 <- factor(data$Q22_2, levels = always.lab)
data1$Q22_3 <- factor(data$Q22_3, levels = always.lab)
data1$Q22_4 <- factor(data$Q22_4, levels = always.lab)
data1$Q22_5 <- factor(data$Q22_5, levels = always.lab)
data1$Q22_6 <- factor(data$Q22_6, levels = always.lab)
data1$Q22_7 <- factor(data$Q22_7, levels = always.lab)
data1$Q22_8 <- factor(data$Q22_8, levels = always.lab)
data1$Q22_9 <- factor(data$Q22_9, levels = always.lab)
levels(data1$Q22_9)
