...
ggplot(data[!is.na(data$Q13), ]) + geom_bar(mapping = aes(x = Q13, fill = Q13), position = position_dodge())
```
...
```{r}
with(data, table(Q14))
ggplot(data[!is.na(data$Q14), ]) + geom_bar(mapping = aes(x = Q14, fill = Q14), position = position_dodge())
...
```{r}
with(data, table(Q15))
ggplot(data[!is.na(data$Q15), ]) + geom_bar(mapping = aes(x = Q15, fill = Q15), position = position_dodge())
...
```{r}
with(data, table(Q16))
ggplot(data[!is.na(data$Q16), ]) + geom_bar(mapping = aes(x = Q16, fill = Q16), position = position_dodge())
...
```{r}
with(data, table(Q17))
ggplot(data[!is.na(data$Q17), ]) + geom_bar(mapping = aes(x = Q17, fill = Q17), position = position_dodge())
...
```{r}
with(data, table(Q19))
ggplot(data[!is.na(data$Q19), ]) + geom_bar(mapping = aes(x = Q19, fill = Q19), position = position_dodge())
```
...
```{r}
with(data, table(Q20))
ggplot(data[!is.na(data$Q20), ]) + geom_bar(mapping = aes(x = Q20, fill = Q20), position = position_dodge())
...
```{r}
with(data, table(Q21))
ggplot(data[!is.na(data$Q21), ]) + geom_bar(mapping = aes(x = Q21, fill = Q21), position = position_dodge())
...
```{r}
with(data, table(Q26))
ggplot(data[!is.na(data$Q26), ]) + geom_bar(mapping = aes(x = Q26, fill = Q26), position = position_dodge())
...
```{r}
with(data, table(Q28))
ggplot(data[!is.na(data$Q28), ]) + geom_bar(mapping = aes(x = Q28, fill = Q28), position = position_dodge())
