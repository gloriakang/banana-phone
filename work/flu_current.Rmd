...
# plot
a + geom_bar(mapping = aes(x = Q1, fill = PPETHM), position = position_dodge())


# PPINCIMP
with(data2, table(PPINCIMP, Q1))
# plot
a + geom_bar(mapping = aes(x = Q1, fill = PPINCIMP), position = position_dodge())
...
# plot
a + geom_bar(mapping = aes(x = Q2, fill = PPETHM), position = position_dodge())


# PPINCIMP
with(data2, table(PPINCIMP, Q2))
# plot
a + geom_bar(mapping = aes(x = Q2, fill = PPINCIMP), position = position_dodge())
```
