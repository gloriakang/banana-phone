...
In the unweighted data frame for Q1, `r u[1]`% of females and `r u[3]`% of males answered Yes. `r u[4]`% of males and `r u[4]`% of females answered No.  
...
`r w[1]`% of all females answered Yes, and `r w[2]`% said No.  
`r w[3]`% of all males answered Yes, and `r w[4]`% said No.  
...
df$mixedrace <- car::recode(datar$PPETHM, recodes = "'2+ Races, Non-Hispanic' = 1; NA = NA; else = 0")
tail(df)
...
When adjusting for gender, ethnicity, employment, and marital status, significant predictors of being sick included female gender (AOR = `r or[2]`) and hispanic ethnicity (AOR = `r or[4]`)
