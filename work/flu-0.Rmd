...
```
In the unweighted data frame, `r u[1]`% of females answered Yes to Q1; males = `r u[3]`%; `r u[4]`% of males answered No; females = `r u[4]`%  
In the weighted data frame, `r w[1]`% of females answered Yes; males = `r w[3]`%; `r w[4]`% of males answered No; females = `r w[2]`%.  
...
In the unweighted data frame, males had `r q2.u[2]` odds of being sick compared to females.  
