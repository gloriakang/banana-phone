...
# Q12
rename("Avoid touching my eyes" = Q12_1,
...
# Q22
rename("Go to a doctor_s office or medical clinic" = Q22_1,
...
# Q23
rename("Stand away from people" = Q23_1,
...
# Q24
rename("Print media such as newspapers and magazines" = Q24_1,
...
# Q25
rename("Stand away from people" = Q25_1,
...
# Q27
rename("Keep the child away from the others in the residence" = Q27_1,
...
# Q29
rename("A parent brings the child to work" = Q29_1,
...
# Q30
rename("I bring the child to work" = Q30_1,
       "I stay home" = Q30_2,
